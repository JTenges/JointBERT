from transformers.modeling_bert import BertEncoder, BertPooler, BertEmbeddings, BaseModelOutputWithPoolingAndCrossAttentions
...
class BertEmbeddingsV2(BertEmbeddings):
    def __init__(self, config):
        ...
        num_entities = 1000
        self.entity_embeddings = nn.Embedding(num_entities, config.hidden_size)
